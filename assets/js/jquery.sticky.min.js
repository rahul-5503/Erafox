...
!function(t) {
    var e = {
        ...
        r = i.height(),
        o = function() {
            for (var e = i.scrollTop(), o = n.height(), c = 0; c < s.length; c++) {
                var p = s[c],
                ...
                if (d <= e) {
                    var u = p.topSpacing;
                    p.stickyElement.css("position", "fixed").css("top", u), "undefined" != typeof p.getWidthFrom && p.stickyElement.css("width", t(p.getWidthFrom).width()), p.stickyElement.trigger("sticky-start", [p]).parent().addClass(p.className), p.currentTop = u;
                } else {
                    null !== p.currentTop && (p.stickyElement.css("position", "").css("top", ""), p.stickyElement.trigger("sticky-end", [p]).parent().removeClass(p.className), p.currentTop = null);
                }
            }
        },
        a = function() {
